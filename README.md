...
## Setup
1. Install Talon & Download Talon Community Repository
https://talon.wiki/Resource%20Hub/Talon%20Installation/installation_guide
...
- Launch git CMD
- At the prompt, enter: 	cd "appdata\talon\user" 
or say:				'go talon user'
- At the prompt, enter:		
